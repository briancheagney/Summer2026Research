...
{
	static inline consteval int32 GetStructSize() { return sizeof(FOWLActorLayer); }
	static inline consteval int16 GetStructAlignment() { return alignof(FOWLActorLayer); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FOWLActorLayer constinit property declarations ********************
...
// ********** End ScriptStruct FOWLActorLayer constinit property declarations **********************
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FOWLActorLayer;
class UScriptStruct* FOWLActorLayer::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FOWLActorLayer.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FOWLActorLayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOWLActorLayer, (UObject*)Z_Construct_UPackage__Script_OWLComposure(), TEXT("OWLActorLayer"));
	}
	return Z_Registration_Info_UScriptStruct_FOWLActorLayer.OuterSingleton;
	}

// ********** Begin ScriptStruct FOWLActorLayer Property Definitions *******************************
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOWLActorLayer_Statics::NewProp_ActorSet = { "ActorSet", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLActorLayer, ActorSet), Z_Construct_UScriptStruct_FActorLayer, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActorSet_MetaData), NewProp_ActorSet_MetaData) }; // 3028980883
...
// ********** End ScriptStruct FOWLActorLayer Property Definitions *********************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FOWLActorLayer.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FOWLActorLayer.InnerSingleton, Z_Construct_UScriptStruct_FOWLActorLayer_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FOWLActorLayer.InnerSingleton);
}
...
// ********** Begin Function UpdateDistortion constinit property declarations **********************
// ********** End Function UpdateDistortion constinit property declarations ************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWLCGElement_UpdateDistortion_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AOWLCGElement, nullptr, "UpdateDistortion", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AOWLCGElement_UpdateDistortion_Statics::Function_MetaDataParams), Z_Construct_UFunction_AOWLCGElement_UpdateDistortion_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_AOWLCGElement;
UClass* AOWLCGElement::GetPrivateStaticClass()
{
	using TClass = AOWLCGElement;
	if (!Z_Registration_Info_UClass_AOWLCGElement.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("OWLCGElement"),
			Z_Registration_Info_UClass_AOWLCGElement.InnerSingleton,
			StaticRegisterNativesAOWLCGElement,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AOWLCGElement.InnerSingleton;
}
UClass* Z_Construct_UClass_AOWLCGElement_NoRegister()
{
	return AOWLCGElement::GetPrivateStaticClass();
}
...
// ********** Begin Class AOWLCGElement constinit property declarations ****************************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class AOWLCGElement constinit property declarations ******************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("UpdateDistortion"), .Pointer = &AOWLCGElement::execUpdateDistortion },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AOWLCGElement_UpdateDistortion, "UpdateDistortion" }, // 1595510880
	};
...
// ********** Begin Class AOWLCGElement Property Definitions ***************************************
...
// ********** End Class AOWLCGElement Property Definitions *****************************************
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AOWLCGElement_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCompositingInputInterface_NoRegister, (int32)VTABLE_OFFSET(AOWLCGElement, ICompositingInputInterface), false },  // 2134720724
};
...
void AOWLCGElement::StaticRegisterNativesAOWLCGElement()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_AOWLCGElement_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, AOWLCGElement);
AOWLCGElement::~AOWLCGElement() {}
// ********** End Class AOWLCGElement **************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOWLIncludeExclude_StaticEnum, TEXT("EOWLIncludeExclude"), &Z_Registration_Info_UEnum_EOWLIncludeExclude, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1738558264U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FOWLActorLayer::StaticStruct, Z_Construct_UScriptStruct_FOWLActorLayer_Statics::NewStructOps, TEXT("OWLActorLayer"),&Z_Registration_Info_UScriptStruct_FOWLActorLayer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLActorLayer), 3231209916U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AOWLCGElement, AOWLCGElement::StaticClass, TEXT("AOWLCGElement"), &Z_Registration_Info_UClass_AOWLCGElement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOWLCGElement), 2154128328U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_1457112258{
	TEXT("/Script/OWLComposure"),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGElement_h__Script_OWLComposure_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
