...
#include "OWLCGCaptureComponent.h"
...
FClassRegistrationInfo Z_Registration_Info_UClass_UOWLCGCaptureComponent;
UClass* UOWLCGCaptureComponent::GetPrivateStaticClass()
{
	using TClass = UOWLCGCaptureComponent;
	if (!Z_Registration_Info_UClass_UOWLCGCaptureComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("OWLCGCaptureComponent"),
			Z_Registration_Info_UClass_UOWLCGCaptureComponent.InnerSingleton,
			StaticRegisterNativesUOWLCGCaptureComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UOWLCGCaptureComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UOWLCGCaptureComponent_NoRegister()
{
	return UOWLCGCaptureComponent::GetPrivateStaticClass();
}
...
// ********** Begin Class UOWLCGCaptureComponent constinit property declarations *******************
...
// ********** End Class UOWLCGCaptureComponent constinit property declarations *********************
...
// ********** End Class UOWLCGCaptureComponent Property Definitions ********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UOWLCGCaptureComponent);
UOWLCGCaptureComponent::~UOWLCGCaptureComponent() {}
// ********** End Class UOWLCGCaptureComponent *****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGCaptureComponent_h__Script_OWLComposure_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOWLCGCaptureComponent, UOWLCGCaptureComponent::StaticClass, TEXT("UOWLCGCaptureComponent"), &Z_Registration_Info_UClass_UOWLCGCaptureComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLCGCaptureComponent), 4164191799U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGCaptureComponent_h__Script_OWLComposure_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGCaptureComponent_h__Script_OWLComposure_2956071838{
	TEXT("/Script/OWLComposure"),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGCaptureComponent_h__Script_OWLComposure_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLCGCaptureComponent_h__Script_OWLComposure_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
