...
#include "OWLPlaneTransformPass.h"
...
FClassRegistrationInfo Z_Registration_Info_UClass_UOWLPlaneTransformPass;
UClass* UOWLPlaneTransformPass::GetPrivateStaticClass()
{
	using TClass = UOWLPlaneTransformPass;
	if (!Z_Registration_Info_UClass_UOWLPlaneTransformPass.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("OWLPlaneTransformPass"),
			Z_Registration_Info_UClass_UOWLPlaneTransformPass.InnerSingleton,
			StaticRegisterNativesUOWLPlaneTransformPass,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UOWLPlaneTransformPass.InnerSingleton;
}
UClass* Z_Construct_UClass_UOWLPlaneTransformPass_NoRegister()
{
	return UOWLPlaneTransformPass::GetPrivateStaticClass();
}
...
// ********** Begin Class UOWLPlaneTransformPass constinit property declarations *******************
...
// ********** End Class UOWLPlaneTransformPass constinit property declarations *********************
...
// ********** Begin Class UOWLPlaneTransformPass Property Definitions ******************************
...
// ********** End Class UOWLPlaneTransformPass Property Definitions ********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UOWLPlaneTransformPass);
// ********** End Class UOWLPlaneTransformPass *****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h__Script_OWLComposure_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOWLPlaneTransformPass, UOWLPlaneTransformPass::StaticClass, TEXT("UOWLPlaneTransformPass"), &Z_Registration_Info_UClass_UOWLPlaneTransformPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLPlaneTransformPass), 1470258334U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h__Script_OWLComposure_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h__Script_OWLComposure_2844456131{
	TEXT("/Script/OWLComposure"),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h__Script_OWLComposure_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h__Script_OWLComposure_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
