...
{
	static inline consteval int32 GetStructSize() { return sizeof(FNDISource); }
	static inline consteval int16 GetStructAlignment() { return alignof(FNDISource); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FNDISource constinit property declarations ************************
	static const UECodeGen_Private::FStrPropertyParams NewProp_Name;
	static const UECodeGen_Private::FStrPropertyParams NewProp_URL;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FNDISource constinit property declarations **************************
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FNDISource;
class UScriptStruct* FNDISource::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FNDISource.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FNDISource.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNDISource, (UObject*)Z_Construct_UPackage__Script_OWLNDI(), TEXT("NDISource"));
	}
	return Z_Registration_Info_UScriptStruct_FNDISource.OuterSingleton;
	}

// ********** Begin ScriptStruct FNDISource Property Definitions ***********************************
...
// ********** End ScriptStruct FNDISource Property Definitions *************************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FNDISource.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FNDISource.InnerSingleton, Z_Construct_UScriptStruct_FNDISource_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FNDISource.InnerSingleton);
}
// ********** End ScriptStruct FNDISource **********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h__Script_OWLNDI_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FNDISource::StaticStruct, Z_Construct_UScriptStruct_FNDISource_Statics::NewStructOps, TEXT("NDISource"),&Z_Registration_Info_UScriptStruct_FNDISource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDISource), 2959272678U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h__Script_OWLNDI_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h__Script_OWLNDI_3128308095{
	TEXT("/Script/OWLNDI"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h__Script_OWLNDI_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h__Script_OWLNDI_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
