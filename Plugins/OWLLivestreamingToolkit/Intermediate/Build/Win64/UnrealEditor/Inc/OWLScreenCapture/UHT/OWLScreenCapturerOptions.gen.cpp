...
{
	static inline consteval int32 GetStructSize() { return sizeof(FOWLScreenCaptureOptions); }
	static inline consteval int16 GetStructAlignment() { return alignof(FOWLScreenCaptureOptions); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FOWLScreenCaptureOptions constinit property declarations **********
...
// ********** End ScriptStruct FOWLScreenCaptureOptions constinit property declarations ************
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions;
class UScriptStruct* FOWLScreenCaptureOptions::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOWLScreenCaptureOptions, (UObject*)Z_Construct_UPackage__Script_OWLScreenCapture(), TEXT("OWLScreenCaptureOptions"));
	}
	return Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.OuterSingleton;
	}

// ********** Begin ScriptStruct FOWLScreenCaptureOptions Property Definitions *********************
...
// ********** End ScriptStruct FOWLScreenCaptureOptions Property Definitions ***********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.InnerSingleton, Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions.InnerSingleton);
}
// ********** End ScriptStruct FOWLScreenCaptureOptions ********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOWLScreenCaptureType_StaticEnum, TEXT("EOWLScreenCaptureType"), &Z_Registration_Info_UEnum_EOWLScreenCaptureType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3161886886U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FOWLScreenCaptureOptions::StaticStruct, Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewStructOps, TEXT("OWLScreenCaptureOptions"),&Z_Registration_Info_UScriptStruct_FOWLScreenCaptureOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLScreenCaptureOptions), 3834374699U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_3571555449{
	TEXT("/Script/OWLScreenCapture"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h__Script_OWLScreenCapture_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
