...
template<> OWLMEDIA_NON_ATTRIBUTED_API UEnum* StaticEnum<EOWLEncoderProfile>()
{
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_FOWLEncoderProfiles_h__Script_OWLMedia_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOWLEncoderProfile_StaticEnum, TEXT("EOWLEncoderProfile"), &Z_Registration_Info_UEnum_EOWLEncoderProfile, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3565103764U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_FOWLEncoderProfiles_h__Script_OWLMedia_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_FOWLEncoderProfiles_h__Script_OWLMedia_872715061{
	TEXT("/Script/OWLMedia"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_FOWLEncoderProfiles_h__Script_OWLMedia_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_FOWLEncoderProfiles_h__Script_OWLMedia_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
