...
FClassRegistrationInfo Z_Registration_Info_UClass_AOWLBaseComp;
UClass* AOWLBaseComp::GetPrivateStaticClass()
{
	using TClass = AOWLBaseComp;
	if (!Z_Registration_Info_UClass_AOWLBaseComp.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("OWLBaseComp"),
			Z_Registration_Info_UClass_AOWLBaseComp.InnerSingleton,
			StaticRegisterNativesAOWLBaseComp,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AOWLBaseComp.InnerSingleton;
}
UClass* Z_Construct_UClass_AOWLBaseComp_NoRegister()
{
	return AOWLBaseComp::GetPrivateStaticClass();
}
...
// ********** Begin Class AOWLBaseComp constinit property declarations *****************************
// ********** End Class AOWLBaseComp constinit property declarations *******************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, AOWLBaseComp);
AOWLBaseComp::~AOWLBaseComp() {}
// ********** End Class AOWLBaseComp ***************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLBaseComp_h__Script_OWLComposure_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AOWLBaseComp, AOWLBaseComp::StaticClass, TEXT("AOWLBaseComp"), &Z_Registration_Info_UClass_AOWLBaseComp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOWLBaseComp), 3863873191U) },
	};
}; // Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLBaseComp_h__Script_OWLComposure_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLBaseComp_h__Script_OWLComposure_2391180910{
	TEXT("/Script/OWLComposure"),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLBaseComp_h__Script_OWLComposure_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLBaseComp_h__Script_OWLComposure_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
